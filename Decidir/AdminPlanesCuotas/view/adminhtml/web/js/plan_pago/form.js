        ...
        return Component.extend({
            ...
            initialize: function ()
            {
                ...
                if(this.plan_pago)
                {
                    ...
                    this.merchant(this.plan_pago.merchant);
            ...
            agregarCuota : function ()
            {
                ...
                var inputTea     = "<input type='text'   class='plan-cuota input-text admin__control-text' name='tea' required='' aria-required='true' />";
                var inputCft     = "<input type='text'   class='plan-cuota input-text admin__control-text' name='cft' required='' aria-required='true' />";
                ...
                var inputCuotaEnviar = "<input type='number' min='0' class='plan-cuota input-text admin__control-text cuota-enviar' name='cuota_gateway' />";
                ...
                var labelInteres     = "<label for='interes'>Coeficiente:</label>";
                var labelTea     = "<label for='tea'>% TEA:</label>";
                var labelCft     = "<label for='cft'>% CFT:</label>";
                var labelReintegro   = "<label for='reintegro'>Reintegro bancario:</label>";
            ...
            guardarPlan: function (dataForm)
            {
                ...
                $.each(cuotas,function(i,val)
                {
                    ...
                    var tea             = li.children("input[name='tea']");
                    var cft             = li.children("input[name='cft']");
                    ...
                    var cuota_enviar    = li.children("input[name='cuota_gateway']");
                    ...
                    datosGrabar.cuotas[i][tea.attr('name')]             = tea.val();
                    datosGrabar.cuotas[i][cft.attr('name')]             = cft.val();
                ...
                console.log( JSON.stringify(datosGrabar) );*/
